        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <select
              id="customer"
              name="customerId"
              className="peer block w-full cursor-pointer rounded-md border text-black border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-black"
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative text-black">
              <input
                ...
                className="peer block w-full rounded-md border border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-mute"
              />
              <CurrencyDollarIcon className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-black peer-focus:text-gray-900" />
            </div>
          </div>
        </div>
        {state.errors?.amount &&
